...
<div class="wrap">
	...
	<form action="#" method="post">
		<table class="form-table">
			<tr>
				<th><label for="manage_credits"><?php _e( 'Credits an Mitglieder senden', $this->text_domain ); ?></label></th>
				<td>
					...
					onchange="if(this.checked) jQuery('#username').css('display',''); else jQuery('#username').css('display','none');" />Credits an ein einzelnes Mitglied senden</label>
					<br />
					<label><input type="radio" name="manage_credits" value="send_all"
						<?php if ( $send_to == 'send_all' ) echo 'checked="checked"';  ?>
					onchange="if(this.checked) jQuery('#username').css('display','none'); else jQuery('#username').css('display','');" />Credits an alle Mitglieder senden</label>
				</td>
			</tr>
			<tr>
				<th><label for="manage_credits_count"><?php _e( 'Anzahl der Credits', $this->text_domain ); ?></label></th>
				<td>
			...
			<tr id="username" <?php if ( $send_to != 'send_single' ) echo 'style="display:none;"'; ?>>
				<th><label for="manage_credits_user"><?php _e( 'Benutzername', $this->text_domain ); ?></label></th>
				<td>
		...
		<p class="submit">
			...
			<input type="submit" class="button-primary" name="save" value="<?php _e( 'Credits senden', $this->text_domain ); ?>" />
		</p>
	</form>
</div>