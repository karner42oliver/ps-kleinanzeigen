...
<div class="wrap">
	...
	<h1><?php _e( 'Kleinanzeigen-Checkout', $this->text_domain ); ?></h1>

		<table class="form-table">
			<tr>
				<th>
					<label for="annual_cost"><?php _e('Jahreszahlungs-Option', $this->text_domain ) ?></label>
				</th>
				<td>
					...
					<span class="description"><?php _e( 'Preis der Jahresoption.', $this->text_domain ); ?></span>
					<br /><br />
					<input type="text" name="annual_txt" value="<?php if ( isset( $options['annual_txt'] ) ) echo $options['annual_txt']; ?>" />
					<span class="description"><?php _e( 'Text fuer die Jahresoption.', $this->text_domain ); ?></span>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					...
					<span class="description"><?php _e( 'Preis der Einmalzahlung.', $this->text_domain ); ?></span>
					<br /><br />
