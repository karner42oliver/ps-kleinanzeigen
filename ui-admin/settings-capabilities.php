...
<div class="wrap">
	...
	<h1><?php _e( 'Rechte-Einstellungen', $this->text_domain ); ?></h1>

	<form action="#" method="post" class="cf-general" >
		<div class="postbox">
			<h3 class='hndle'><span><?php _e( 'Rechte', $this->text_domain ) ?></span></h3>
			<div class="inside">
				<table class="form-table">
					<tr>
						<th>
							<label for="roles"><?php _e( 'Rechte zuweisen', $this->text_domain ) ?></label>
						...
						<td>
							...
							<br /><span class="description"><?php _e('Waehle die Rolle aus, der du Kleinanzeigen-Rechte geben willst.', $this->text_domain); ?></span>
		...
		<p class="submit">
			...
			<input type="submit" class="button-primary" name="save" value="<?php _e( 'Aenderungen fuer diese Rolle speichern', $this->text_domain ); ?>">
		</p>
	</form>
</div>
